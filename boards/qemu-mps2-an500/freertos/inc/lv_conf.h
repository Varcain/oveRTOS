/*
 * LVGL v9 configuration for QEMU MPS2-AN500.
 * Based on STM32F746G-Discovery config, adapted for emulated target.
 */
...
/* LVGL memory pool — generous on QEMU (4MB RAM) */
...
/* OS — single-task access with external mutex */
...
/* Logging — enable for debug on QEMU */
#define LV_USE_LOG 0
