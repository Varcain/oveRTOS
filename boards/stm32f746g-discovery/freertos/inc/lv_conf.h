...
/*
 * LVGL v9 configuration for STM32F746G-Discovery FreeRTOS.
 *
 * Board-specific knobs live here. Widgets, themes, layouts, features, and
 * other cross-cutting bits come from <ove/lv_conf_common.h>.
 */
...
/* LV_OS_NONE — display is only accessed from a single task and STM32Cube
 * FreeRTOS doesn't expose atomic.h that LVGL's os wrapper expects. */
