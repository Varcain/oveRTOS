 ...
 * backends/common/ove_lnx_ove_disp_adapter.c (bridging to ove_fb_* / ove_ft5336_*).
 * Display geometry, which used to come from the per-board board_desc.h, is now an
 * injected value (ove_lnx_disp_set_geometry). Renamed to lxp_display_ops_t at the
 ...
 * ove_ft5336 adapter). */
extern const struct ove_lnx_disp_ops *g_ove_lnx_disp_ops;
