...
fn main() {
    ...
    builder = builder
        ...
        .allowlist_function("lv_chart_set_range")
        ...
        .allowlist_function("lv_chart_set_value_by_id")
        ...
        .allowlist_function("lv_calendar_set_showed_date")
        .allowlist_function("lv_calendar_set_highlighted_dates")
        .allowlist_function("lv_calendar_get_pressed_date")
        .allowlist_function("lv_calendar_header_arrow_create")
        .allowlist_function("lv_calendar_header_dropdown_create")
