...
pub type ove_err = ::std::os::raw::c_int;
#[doc = " @brief oveRTOS error codes.\n\n Convention: zero (@c OVE_OK) on success, negative values on error.\n Numeric values are pinned by the @c _Static_assert block below — the\n names and codes form the stable C ABI between substrate and bindings.\n\n Function APIs return @c int (not @c ove_err_t) for ABI compatibility\n and to keep the @c int rc = ...; if (rc < 0) idiom unchanged.\n Bindings consume the typed enum via bindgen / @c \\@cImport."]
...
pub type ove_dma_complete_cb = ::std::option::Option<
    unsafe extern "C" fn(result: ::std::os::raw::c_int, user_data: *mut ::std::os::raw::c_void),
>;
...
unsafe extern "C" {
    ...
    pub fn ove_console_init() -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_console_getchar() -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_console_putchar(c: ::std::os::raw::c_int);
}
unsafe extern "C" {
    ...
    pub fn ove_console_write(buf: *const ::std::os::raw::c_char, len: ::std::os::raw::c_uint);
}
unsafe extern "C" {
    #[doc = " @brief Feed a log line into the httpd log ring buffer.\n\n Call from the log output hook to capture lines for GET /api/log."]
    pub fn ove_httpd_log_append(line: *const ::std::os::raw::c_char);
}
...
pub type ove_thread_state_t = ::std::os::raw::c_uint;
...
const _: () = {
    ["Size of ove_thread_stats"][::std::mem::size_of::<ove_thread_stats>() - 16usize];
    ["Alignment of ove_thread_stats"][::std::mem::align_of::<ove_thread_stats>() - 8usize];
    ["Offset of field: ove_thread_stats::runtime_us"]
        [::std::mem::offset_of!(ove_thread_stats, runtime_us) - 0usize];
    ["Offset of field: ove_thread_stats::cpu_percent_x100"]
        [::std::mem::offset_of!(ove_thread_stats, cpu_percent_x100) - 8usize];
};
...
pub type ove_prio_t = ::std::os::raw::c_uint;
#[doc = " @cond INTERNAL"]
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_mutex_storage_t"][::std::mem::size_of::<ove_mutex_storage_t>() - 40usize];
    ["Alignment of ove_mutex_storage_t"][::std::mem::align_of::<ove_mutex_storage_t>() - 8usize];
    ["Offset of field: ove_mutex_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_mutex_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_sem_storage_t"][::std::mem::size_of::<ove_sem_storage_t>() - 32usize];
    ["Alignment of ove_sem_storage_t"][::std::mem::align_of::<ove_sem_storage_t>() - 8usize];
    ["Offset of field: ove_sem_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_sem_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_event_storage_t"][::std::mem::size_of::<ove_event_storage_t>() - 96usize];
    ["Alignment of ove_event_storage_t"][::std::mem::align_of::<ove_event_storage_t>() - 8usize];
    ["Offset of field: ove_event_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_event_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_condvar_storage_t"][::std::mem::size_of::<ove_condvar_storage_t>() - 48usize];
    ["Alignment of ove_condvar_storage_t"]
        [::std::mem::align_of::<ove_condvar_storage_t>() - 8usize];
    ["Offset of field: ove_condvar_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_condvar_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_thread_storage_t"][::std::mem::size_of::<ove_thread_storage_t>() - 128usize];
    ["Alignment of ove_thread_storage_t"][::std::mem::align_of::<ove_thread_storage_t>() - 8usize];
    ["Offset of field: ove_thread_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_thread_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_queue_storage_t"][::std::mem::size_of::<ove_queue_storage_t>() - 168usize];
    ["Alignment of ove_queue_storage_t"][::std::mem::align_of::<ove_queue_storage_t>() - 8usize];
    ["Offset of field: ove_queue_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_queue_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_timer_storage_t"][::std::mem::size_of::<ove_timer_storage_t>() - 40usize];
    ["Alignment of ove_timer_storage_t"][::std::mem::align_of::<ove_timer_storage_t>() - 8usize];
    ["Offset of field: ove_timer_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_timer_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ["Size of ove_eventgroup_storage_t"]
        [::std::mem::size_of::<ove_eventgroup_storage_t>() - 96usize];
    ["Alignment of ove_eventgroup_storage_t"]
        [::std::mem::align_of::<ove_eventgroup_storage_t>() - 8usize];
    ["Offset of field: ove_eventgroup_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_eventgroup_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ["Size of ove_workqueue_storage_t"]
        [::std::mem::size_of::<ove_workqueue_storage_t>() - 616usize];
    ["Alignment of ove_workqueue_storage_t"]
        [::std::mem::align_of::<ove_workqueue_storage_t>() - 8usize];
    ["Offset of field: ove_workqueue_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_workqueue_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_work_storage_t"][::std::mem::size_of::<ove_work_storage_t>() - 32usize];
    ["Alignment of ove_work_storage_t"][::std::mem::align_of::<ove_work_storage_t>() - 8usize];
    ["Offset of field: ove_work_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_work_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_stream_storage_t"][::std::mem::size_of::<ove_stream_storage_t>() - 184usize];
    ["Alignment of ove_stream_storage_t"][::std::mem::align_of::<ove_stream_storage_t>() - 8usize];
    ["Offset of field: ove_stream_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_stream_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_watchdog_storage_t"][::std::mem::size_of::<ove_watchdog_storage_t>() - 16usize];
    ["Alignment of ove_watchdog_storage_t"]
        [::std::mem::align_of::<ove_watchdog_storage_t>() - 8usize];
    ["Offset of field: ove_watchdog_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_watchdog_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(4))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_file_storage_t"][::std::mem::size_of::<ove_file_storage_t>() - 4usize];
    ["Alignment of ove_file_storage_t"][::std::mem::align_of::<ove_file_storage_t>() - 4usize];
    ["Offset of field: ove_file_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_file_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_dir_storage_t"][::std::mem::size_of::<ove_dir_storage_t>() - 8usize];
    ["Alignment of ove_dir_storage_t"][::std::mem::align_of::<ove_dir_storage_t>() - 8usize];
    ["Offset of field: ove_dir_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_dir_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_model_storage_t"][::std::mem::size_of::<ove_model_storage_t>() - 64usize];
    ["Alignment of ove_model_storage_t"][::std::mem::align_of::<ove_model_storage_t>() - 8usize];
    ["Offset of field: ove_model_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_model_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_socket_storage_t"][::std::mem::size_of::<ove_socket_storage_t>() - 64usize];
    ["Alignment of ove_socket_storage_t"][::std::mem::align_of::<ove_socket_storage_t>() - 8usize];
    ["Offset of field: ove_socket_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_socket_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_netif_storage_t"][::std::mem::size_of::<ove_netif_storage_t>() - 64usize];
    ["Alignment of ove_netif_storage_t"][::std::mem::align_of::<ove_netif_storage_t>() - 8usize];
    ["Offset of field: ove_netif_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_netif_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_tls_storage_t"][::std::mem::size_of::<ove_tls_storage_t>() - 128usize];
    ["Alignment of ove_tls_storage_t"][::std::mem::align_of::<ove_tls_storage_t>() - 8usize];
    ["Offset of field: ove_tls_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_tls_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ["Size of ove_http_client_storage_t"]
        [::std::mem::size_of::<ove_http_client_storage_t>() - 64usize];
    ["Alignment of ove_http_client_storage_t"]
        [::std::mem::align_of::<ove_http_client_storage_t>() - 8usize];
    ["Offset of field: ove_http_client_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_http_client_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ["Size of ove_mqtt_client_storage_t"]
        [::std::mem::size_of::<ove_mqtt_client_storage_t>() - 128usize];
    ["Alignment of ove_mqtt_client_storage_t"]
        [::std::mem::align_of::<ove_mqtt_client_storage_t>() - 8usize];
    ["Offset of field: ove_mqtt_client_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_mqtt_client_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_uart_storage_t"][::std::mem::size_of::<ove_uart_storage_t>() - 64usize];
    ["Alignment of ove_uart_storage_t"][::std::mem::align_of::<ove_uart_storage_t>() - 8usize];
    ["Offset of field: ove_uart_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_uart_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_spi_storage_t"][::std::mem::size_of::<ove_spi_storage_t>() - 64usize];
    ["Alignment of ove_spi_storage_t"][::std::mem::align_of::<ove_spi_storage_t>() - 8usize];
    ["Offset of field: ove_spi_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_spi_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_i2c_storage_t"][::std::mem::size_of::<ove_i2c_storage_t>() - 64usize];
    ["Alignment of ove_i2c_storage_t"][::std::mem::align_of::<ove_i2c_storage_t>() - 8usize];
    ["Offset of field: ove_i2c_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_i2c_storage_t, _opaque) - 0usize];
};
#[repr(C)]
#[repr(align(8))]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_i2s_storage_t"][::std::mem::size_of::<ove_i2s_storage_t>() - 64usize];
    ["Alignment of ove_i2s_storage_t"][::std::mem::align_of::<ove_i2s_storage_t>() - 8usize];
    ["Offset of field: ove_i2s_storage_t::_opaque"]
        [::std::mem::offset_of!(ove_i2s_storage_t, _opaque) - 0usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_thread_deinit(handle: ove_thread_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_thread_destroy(handle: ove_thread_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_mem_stats"][::std::mem::size_of::<ove_mem_stats>() - 32usize];
    ["Alignment of ove_mem_stats"][::std::mem::align_of::<ove_mem_stats>() - 8usize];
    ["Offset of field: ove_mem_stats::total"]
        [::std::mem::offset_of!(ove_mem_stats, total) - 0usize];
    ["Offset of field: ove_mem_stats::free"][::std::mem::offset_of!(ove_mem_stats, free) - 8usize];
    ["Offset of field: ove_mem_stats::used"][::std::mem::offset_of!(ove_mem_stats, used) - 16usize];
    ["Offset of field: ove_mem_stats::peak_used"]
        [::std::mem::offset_of!(ove_mem_stats, peak_used) - 24usize];
};
unsafe extern "C" {
    ...
    pub fn ove_sys_get_mem_stats(stats: *mut ove_mem_stats) -> ::std::os::raw::c_int;
}
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_thread_state_times"][::std::mem::size_of::<ove_thread_state_times>() - 32usize];
    ["Alignment of ove_thread_state_times"]
        [::std::mem::align_of::<ove_thread_state_times>() - 8usize];
    ["Offset of field: ove_thread_state_times::running_us"]
        [::std::mem::offset_of!(ove_thread_state_times, running_us) - 0usize];
    ["Offset of field: ove_thread_state_times::ready_us"]
        [::std::mem::offset_of!(ove_thread_state_times, ready_us) - 8usize];
    ["Offset of field: ove_thread_state_times::blocked_us"]
        [::std::mem::offset_of!(ove_thread_state_times, blocked_us) - 16usize];
    ["Offset of field: ove_thread_state_times::suspended_us"]
        [::std::mem::offset_of!(ove_thread_state_times, suspended_us) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_thread_info"][::std::mem::size_of::<ove_thread_info>() - 72usize];
    ["Alignment of ove_thread_info"][::std::mem::align_of::<ove_thread_info>() - 8usize];
    ["Offset of field: ove_thread_info::name"]
        [::std::mem::offset_of!(ove_thread_info, name) - 0usize];
    ["Offset of field: ove_thread_info::state"]
        [::std::mem::offset_of!(ove_thread_info, state) - 8usize];
    ["Offset of field: ove_thread_info::priority"]
        [::std::mem::offset_of!(ove_thread_info, priority) - 12usize];
    ["Offset of field: ove_thread_info::stack_used"]
        [::std::mem::offset_of!(ove_thread_info, stack_used) - 16usize];
    ["Offset of field: ove_thread_info::stack_size"]
        [::std::mem::offset_of!(ove_thread_info, stack_size) - 24usize];
    ["Offset of field: ove_thread_info::cpu_percent_x100"]
        [::std::mem::offset_of!(ove_thread_info, cpu_percent_x100) - 32usize];
    ["Offset of field: ove_thread_info::state_times"]
        [::std::mem::offset_of!(ove_thread_info, state_times) - 40usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_time_get_us(out: *mut u64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_time_get_ns(out: *mut u64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_mutex_create(mtx: *mut ove_mutex_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_event_create(evt: *mut ove_event_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_recursive_mutex_create(mtx: *mut ove_mutex_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_condvar_create(cv: *mut ove_condvar_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_mutex_lock(mtx: ove_mutex_t, timeout_ns: u64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_sem_take(sem: ove_sem_t, timeout_ns: u64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_event_wait(evt: ove_event_t, timeout_ns: u64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_recursive_mutex_lock(mtx: ove_mutex_t, timeout_ns: u64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub type ove_audio_sample_fmt = ::std::os::raw::c_uint;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_fmt"][::std::mem::size_of::<ove_audio_fmt>() - 12usize];
    ["Alignment of ove_audio_fmt"][::std::mem::align_of::<ove_audio_fmt>() - 4usize];
    ["Offset of field: ove_audio_fmt::sample_rate"]
        [::std::mem::offset_of!(ove_audio_fmt, sample_rate) - 0usize];
    ["Offset of field: ove_audio_fmt::channels"]
        [::std::mem::offset_of!(ove_audio_fmt, channels) - 4usize];
    ["Offset of field: ove_audio_fmt::sample_fmt"]
        [::std::mem::offset_of!(ove_audio_fmt, sample_fmt) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_buf"][::std::mem::size_of::<ove_audio_buf>() - 24usize];
    ["Alignment of ove_audio_buf"][::std::mem::align_of::<ove_audio_buf>() - 8usize];
    ["Offset of field: ove_audio_buf::data"][::std::mem::offset_of!(ove_audio_buf, data) - 0usize];
    ["Offset of field: ove_audio_buf::frames"]
        [::std::mem::offset_of!(ove_audio_buf, frames) - 8usize];
    ["Offset of field: ove_audio_buf::fmt"][::std::mem::offset_of!(ove_audio_buf, fmt) - 16usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_node_ops"][::std::mem::size_of::<ove_audio_node_ops>() - 40usize];
    ["Alignment of ove_audio_node_ops"][::std::mem::align_of::<ove_audio_node_ops>() - 8usize];
    ["Offset of field: ove_audio_node_ops::configure"]
        [::std::mem::offset_of!(ove_audio_node_ops, configure) - 0usize];
    ["Offset of field: ove_audio_node_ops::start"]
        [::std::mem::offset_of!(ove_audio_node_ops, start) - 8usize];
    ["Offset of field: ove_audio_node_ops::stop"]
        [::std::mem::offset_of!(ove_audio_node_ops, stop) - 16usize];
    ["Offset of field: ove_audio_node_ops::process"]
        [::std::mem::offset_of!(ove_audio_node_ops, process) - 24usize];
    ["Offset of field: ove_audio_node_ops::destroy"]
        [::std::mem::offset_of!(ove_audio_node_ops, destroy) - 32usize];
};
...
pub type ove_audio_node_type = ::std::os::raw::c_uint;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_node"][::std::mem::size_of::<ove_audio_node>() - 48usize];
    ["Alignment of ove_audio_node"][::std::mem::align_of::<ove_audio_node>() - 8usize];
    ["Offset of field: ove_audio_node::name"]
        [::std::mem::offset_of!(ove_audio_node, name) - 0usize];
    ["Offset of field: ove_audio_node::type_"]
        [::std::mem::offset_of!(ove_audio_node, type_) - 8usize];
    ["Offset of field: ove_audio_node::ops"][::std::mem::offset_of!(ove_audio_node, ops) - 16usize];
    ["Offset of field: ove_audio_node::ctx"][::std::mem::offset_of!(ove_audio_node, ctx) - 24usize];
    ["Offset of field: ove_audio_node::out_fmt"]
        [::std::mem::offset_of!(ove_audio_node, out_fmt) - 32usize];
};
...
pub struct ove_audio_channel_map {
    ...
    pub out_channels: ::std::os::raw::c_uint,
    #[doc = "< @brief map[out_ch] = in_ch index, or -1 for silence."]
    pub map: [::std::os::raw::c_int; 8usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_channel_map"][::std::mem::size_of::<ove_audio_channel_map>() - 36usize];
    ["Alignment of ove_audio_channel_map"]
        [::std::mem::align_of::<ove_audio_channel_map>() - 4usize];
    ["Offset of field: ove_audio_channel_map::out_channels"]
        [::std::mem::offset_of!(ove_audio_channel_map, out_channels) - 0usize];
    ["Offset of field: ove_audio_channel_map::map"]
        [::std::mem::offset_of!(ove_audio_channel_map, map) - 4usize];
};
...
pub type ove_audio_tap_fn = ::std::option::Option<
    unsafe extern "C" fn(buf: *const ove_audio_buf, user_data: *mut ::std::os::raw::c_void),
>;
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_edge"][::std::mem::size_of::<ove_audio_edge>() - 8usize];
    ["Alignment of ove_audio_edge"][::std::mem::align_of::<ove_audio_edge>() - 4usize];
    ["Offset of field: ove_audio_edge::from"]
        [::std::mem::offset_of!(ove_audio_edge, from) - 0usize];
    ["Offset of field: ove_audio_edge::to"][::std::mem::offset_of!(ove_audio_edge, to) - 4usize];
};
...
pub struct ove_audio_graph_stats {
    ...
    pub cycles: ::std::os::raw::c_uint,
    #[doc = "< @brief Sink starvation events (sink received no data)."]
    pub underruns: ::std::os::raw::c_uint,
    #[doc = "< @brief Source overflow events (source dropped frames)."]
    pub overruns: ::std::os::raw::c_uint,
    #[doc = "< @brief Cumulative node process() failures."]
    pub node_errors: ::std::os::raw::c_uint,
    #[doc = "< @brief Worst-case cycle wall-clock time in microseconds."]
    pub max_process_us: ::std::os::raw::c_uint,
    #[doc = "< @brief Rolling average cycle wall-clock time in microseconds."]
    pub avg_process_us: ::std::os::raw::c_uint,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_graph_stats"][::std::mem::size_of::<ove_audio_graph_stats>() - 24usize];
    ["Alignment of ove_audio_graph_stats"]
        [::std::mem::align_of::<ove_audio_graph_stats>() - 4usize];
    ["Offset of field: ove_audio_graph_stats::cycles"]
        [::std::mem::offset_of!(ove_audio_graph_stats, cycles) - 0usize];
    ["Offset of field: ove_audio_graph_stats::underruns"]
        [::std::mem::offset_of!(ove_audio_graph_stats, underruns) - 4usize];
    ["Offset of field: ove_audio_graph_stats::overruns"]
        [::std::mem::offset_of!(ove_audio_graph_stats, overruns) - 8usize];
    ["Offset of field: ove_audio_graph_stats::node_errors"]
        [::std::mem::offset_of!(ove_audio_graph_stats, node_errors) - 12usize];
    ["Offset of field: ove_audio_graph_stats::max_process_us"]
        [::std::mem::offset_of!(ove_audio_graph_stats, max_process_us) - 16usize];
    ["Offset of field: ove_audio_graph_stats::avg_process_us"]
        [::std::mem::offset_of!(ove_audio_graph_stats, avg_process_us) - 20usize];
};
...
pub type ove_audio_graph_state = ::std::os::raw::c_uint;
...
pub struct ove_audio_graph {
    ...
    pub node_count: ::std::os::raw::c_uint,
    ...
    pub exec_order: [::std::os::raw::c_uint; 16usize],
    #[doc = "< @brief Number of valid entries in @c exec_order[]."]
    pub exec_count: ::std::os::raw::c_uint,
    ...
    pub buf_storage: *mut ::std::os::raw::c_void,
    ...
    pub frames_per_period: ::std::os::raw::c_uint,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_graph"][::std::mem::size_of::<ove_audio_graph>() - 1408usize];
    ["Alignment of ove_audio_graph"][::std::mem::align_of::<ove_audio_graph>() - 8usize];
    ["Offset of field: ove_audio_graph::nodes"]
        [::std::mem::offset_of!(ove_audio_graph, nodes) - 0usize];
    ["Offset of field: ove_audio_graph::node_count"]
        [::std::mem::offset_of!(ove_audio_graph, node_count) - 768usize];
    ["Offset of field: ove_audio_graph::edges"]
        [::std::mem::offset_of!(ove_audio_graph, edges) - 772usize];
    ["Offset of field: ove_audio_graph::edge_count"]
        [::std::mem::offset_of!(ove_audio_graph, edge_count) - 900usize];
    ["Offset of field: ove_audio_graph::exec_order"]
        [::std::mem::offset_of!(ove_audio_graph, exec_order) - 904usize];
    ["Offset of field: ove_audio_graph::exec_count"]
        [::std::mem::offset_of!(ove_audio_graph, exec_count) - 968usize];
    ["Offset of field: ove_audio_graph::buffers"]
        [::std::mem::offset_of!(ove_audio_graph, buffers) - 976usize];
    ["Offset of field: ove_audio_graph::buf_storage"]
        [::std::mem::offset_of!(ove_audio_graph, buf_storage) - 1360usize];
    ["Offset of field: ove_audio_graph::buf_storage_size"]
        [::std::mem::offset_of!(ove_audio_graph, buf_storage_size) - 1368usize];
    ["Offset of field: ove_audio_graph::frames_per_period"]
        [::std::mem::offset_of!(ove_audio_graph, frames_per_period) - 1376usize];
    ["Offset of field: ove_audio_graph::state"]
        [::std::mem::offset_of!(ove_audio_graph, state) - 1380usize];
    ["Offset of field: ove_audio_graph::stats"]
        [::std::mem::offset_of!(ove_audio_graph, stats) - 1384usize];
};
unsafe extern "C" {
    ...
    pub fn ove_audio_graph_init(
        g: *mut ove_audio_graph,
        frames_per_period: ::std::os::raw::c_uint,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_audio_graph_destroy(g: *mut ove_audio_graph) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_audio_graph_build(g: *mut ove_audio_graph) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_audio_graph_start(g: *mut ove_audio_graph) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_audio_graph_stop(g: *mut ove_audio_graph) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_audio_graph_process(g: *mut ove_audio_graph) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub type ove_audio_transport = ::std::os::raw::c_uint;
...
pub struct ove_audio_device_cfg {
    ...
    pub thread_priority: ::std::os::raw::c_uint,
    #[doc = "< @brief Driver thread stack size in bytes; 0 = backend default."]
    pub thread_stack_size: ::std::os::raw::c_uint,
...
pub struct ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_1 {
    ...
    pub input_device: ::std::os::raw::c_uint,
    #[doc = "< @brief TDM slot bitmask; 0 = all slots."]
    pub slot_mask: ::std::os::raw::c_uint,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::size_of::<ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_1>() - 8usize];
    ["Alignment of ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::align_of::<ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_1>() - 4usize];
    ["Offset of field: ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_1::input_device"][::std::mem::offset_of!(
        ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_1,
        input_device
    ) - 0usize];
    ["Offset of field: ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_1::slot_mask"][::std::mem::offset_of!(
        ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_1,
        slot_mask
    ) - 4usize];
};
...
pub struct ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_2 {
    ...
    pub decimation: ::std::os::raw::c_uint,
    #[doc = "< @brief PDM clock frequency in Hz."]
    pub clock_freq: ::std::os::raw::c_uint,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_2"]
        [::std::mem::size_of::<ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_2>() - 8usize];
    ["Alignment of ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_2"]
        [::std::mem::align_of::<ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_2>() - 4usize];
    ["Offset of field: ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_2::decimation"][::std::mem::offset_of!(
        ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_2,
        decimation
    ) - 0usize];
    ["Offset of field: ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_2::clock_freq"][::std::mem::offset_of!(
        ove_audio_device_cfg__bindgen_ty_1__bindgen_ty_2,
        clock_freq
    ) - 4usize];
};
...
const _: () = {
    ["Size of ove_audio_device_cfg__bindgen_ty_1"]
        [::std::mem::size_of::<ove_audio_device_cfg__bindgen_ty_1>() - 8usize];
    ["Alignment of ove_audio_device_cfg__bindgen_ty_1"]
        [::std::mem::align_of::<ove_audio_device_cfg__bindgen_ty_1>() - 4usize];
    ["Offset of field: ove_audio_device_cfg__bindgen_ty_1::i2s"]
        [::std::mem::offset_of!(ove_audio_device_cfg__bindgen_ty_1, i2s) - 0usize];
    ["Offset of field: ove_audio_device_cfg__bindgen_ty_1::pdm"]
        [::std::mem::offset_of!(ove_audio_device_cfg__bindgen_ty_1, pdm) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_audio_device_cfg"][::std::mem::size_of::<ove_audio_device_cfg>() - 36usize];
    ["Alignment of ove_audio_device_cfg"][::std::mem::align_of::<ove_audio_device_cfg>() - 4usize];
    ["Offset of field: ove_audio_device_cfg::transport"]
        [::std::mem::offset_of!(ove_audio_device_cfg, transport) - 0usize];
    ["Offset of field: ove_audio_device_cfg::fmt"]
        [::std::mem::offset_of!(ove_audio_device_cfg, fmt) - 4usize];
    ["Offset of field: ove_audio_device_cfg::num_buffers"]
        [::std::mem::offset_of!(ove_audio_device_cfg, num_buffers) - 16usize];
    ["Offset of field: ove_audio_device_cfg::thread_priority"]
        [::std::mem::offset_of!(ove_audio_device_cfg, thread_priority) - 20usize];
    ["Offset of field: ove_audio_device_cfg::thread_stack_size"]
        [::std::mem::offset_of!(ove_audio_device_cfg, thread_stack_size) - 24usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_dirent"][::std::mem::size_of::<ove_dirent>() - 264usize];
    ["Alignment of ove_dirent"][::std::mem::align_of::<ove_dirent>() - 4usize];
    ["Offset of field: ove_dirent::name"][::std::mem::offset_of!(ove_dirent, name) - 0usize];
    ["Offset of field: ove_dirent::size"][::std::mem::offset_of!(ove_dirent, size) - 256usize];
    ["Offset of field: ove_dirent::is_dir"][::std::mem::offset_of!(ove_dirent, is_dir) - 260usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_fs_close_deinit(file: ove_file_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_fs_closedir_deinit(dir: ove_dir_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_fs_close(file: ove_file_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_fs_closedir(dir: ove_dir_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_fs_unmount(mount_point: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_fs_size(file: ove_file_t, out_size: *mut usize) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_fs_tell(file: ove_file_t) -> ::std::os::raw::c_long;
}
unsafe extern "C" {
    ...
    pub fn ove_fs_readdir(dir: ove_dir_t, entry: *mut ove_dirent) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_fs_unlink(path: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub type ove_timer_fn = ::std::option::Option<
    unsafe extern "C" fn(timer: ove_timer_t, user_data: *mut ::std::os::raw::c_void),
>;
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_timer_set_period_ns(timer: ove_timer_t, period_ns: u64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_timer_start(timer: ove_timer_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_timer_stop(timer: ove_timer_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_timer_reset(timer: ove_timer_t) -> ::std::os::raw::c_int;
}
...
pub struct ove_led_desc {
    ...
    pub pin: ::std::os::raw::c_uint,
    #[doc = "< Non-zero if the LED is lit when the pin is low."]
    pub active_low: ::std::os::raw::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_led_desc"][::std::mem::size_of::<ove_led_desc>() - 12usize];
    ["Alignment of ove_led_desc"][::std::mem::align_of::<ove_led_desc>() - 4usize];
    ["Offset of field: ove_led_desc::port"][::std::mem::offset_of!(ove_led_desc, port) - 0usize];
    ["Offset of field: ove_led_desc::pin"][::std::mem::offset_of!(ove_led_desc, pin) - 4usize];
    ["Offset of field: ove_led_desc::active_low"]
        [::std::mem::offset_of!(ove_led_desc, active_low) - 8usize];
};
...
pub struct ove_board_desc {
    ...
    pub mcu_family: *const ::std::os::raw::c_char,
    #[doc = "< Specific MCU part number (e.g. @c \"STM32F407VGT6\")."]
    pub mcu: *const ::std::os::raw::c_char,
    #[doc = "< Number of GPIO ports available on this board."]
    pub gpio_port_count: ::std::os::raw::c_uint,
    #[doc = "< Number of pins in each GPIO port."]
    pub gpio_pins_per_port: ::std::os::raw::c_uint,
    #[doc = "< Number of on-board LEDs described in @c leds."]
    pub led_count: ::std::os::raw::c_uint,
    #[doc = "< Array of LED descriptors, length @c led_count."]
    pub leds: *const ove_led_desc,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_board_desc"][::std::mem::size_of::<ove_board_desc>() - 48usize];
    ["Alignment of ove_board_desc"][::std::mem::align_of::<ove_board_desc>() - 8usize];
    ["Offset of field: ove_board_desc::name"]
        [::std::mem::offset_of!(ove_board_desc, name) - 0usize];
    ["Offset of field: ove_board_desc::mcu_family"]
        [::std::mem::offset_of!(ove_board_desc, mcu_family) - 8usize];
    ["Offset of field: ove_board_desc::mcu"][::std::mem::offset_of!(ove_board_desc, mcu) - 16usize];
    ["Offset of field: ove_board_desc::gpio_port_count"]
        [::std::mem::offset_of!(ove_board_desc, gpio_port_count) - 24usize];
    ["Offset of field: ove_board_desc::gpio_pins_per_port"]
        [::std::mem::offset_of!(ove_board_desc, gpio_pins_per_port) - 28usize];
    ["Offset of field: ove_board_desc::led_count"]
        [::std::mem::offset_of!(ove_board_desc, led_count) - 32usize];
    ["Offset of field: ove_board_desc::leds"]
        [::std::mem::offset_of!(ove_board_desc, leds) - 40usize];
};
unsafe extern "C" {
    ...
    pub fn ove_board_init() -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_board_name() -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
...
pub type ove_gpio_mode_t = ::std::os::raw::c_uint;
...
pub type ove_gpio_irq_mode_t = ::std::os::raw::c_uint;
...
pub type ove_gpio_irq_cb = ::std::option::Option<
    unsafe extern "C" fn(
...
pub type ove_lvgl_keypad_read_fn_t =
    ::std::option::Option<unsafe extern "C" fn(key: *mut u32, pressed: *mut bool) -> bool>;
...
pub type ove_lvgl_encoder_read_fn_t =
    ::std::option::Option<unsafe extern "C" fn(diff: *mut i16, pressed: *mut bool) -> bool>;
unsafe extern "C" {
    ...
    pub fn ove_lvgl_register_keypad(cb: ove_lvgl_keypad_read_fn_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " @brief Register an encoder input device with LVGL.\n\n Same semantics as ove_lvgl_register_keypad() but for rotary encoder\n (+ push) input."]
    pub fn ove_lvgl_register_encoder(cb: ove_lvgl_encoder_read_fn_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_lvgl_get_keypad_indev() -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
    #[doc = " @brief Returns the encoder LVGL input device handle as @c void*, or\n        @c NULL if none has been registered."]
    pub fn ove_lvgl_get_encoder_indev() -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
    ...
    pub fn ove_lvgl_init() -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn ove_eventgroup_create(eg: *mut ove_eventgroup_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub type ove_work_fn = ::std::option::Option<unsafe extern "C" fn(work: ove_work_t)>;
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_work_init(work: *mut ove_work_t, handler: ove_work_fn) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_work_submit(wq: ove_workqueue_t, work: ove_work_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_work_cancel(work: ove_work_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_stream_reset(stream: ove_stream_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn ove_watchdog_create(wdt: *mut ove_watchdog_t, timeout_ms: u32) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_watchdog_start(wdt: ove_watchdog_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_watchdog_stop(wdt: ove_watchdog_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_watchdog_feed(wdt: ove_watchdog_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_nvs_init() -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_nvs_erase(key: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
...
pub type ove_shell_cmd_fn = ::std::option::Option<
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_shell_cmd"][::std::mem::size_of::<ove_shell_cmd>() - 24usize];
    ["Alignment of ove_shell_cmd"][::std::mem::align_of::<ove_shell_cmd>() - 8usize];
    ["Offset of field: ove_shell_cmd::name"][::std::mem::offset_of!(ove_shell_cmd, name) - 0usize];
    ["Offset of field: ove_shell_cmd::help"][::std::mem::offset_of!(ove_shell_cmd, help) - 8usize];
    ["Offset of field: ove_shell_cmd::handler"]
        [::std::mem::offset_of!(ove_shell_cmd, handler) - 16usize];
};
#[doc = " @brief Shell output hook for capturing command output.\n @param[in] data Output text.\n @param[in] len  Length in bytes."]
pub type ove_shell_output_hook_t =
    ::std::option::Option<unsafe extern "C" fn(data: *const ::std::os::raw::c_char, len: usize)>;
unsafe extern "C" {
    ...
    pub fn ove_shell_init() -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_shell_register_cmd(cmd: *const ove_shell_cmd) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_shell_process_char(c: ::std::os::raw::c_int);
}
unsafe extern "C" {
    ...
    pub fn ove_shell_process_line(line: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_app_run() -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub type ove_tensor_type = ::std::os::raw::c_uint;
...
pub struct ove_tensor_info {
    ...
    pub ndims: ::std::os::raw::c_uint,
    #[doc = "< Shape, e.g. {1, 96, 96, 1}."]
    pub dims: [::std::os::raw::c_int; 5usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_tensor_info"][::std::mem::size_of::<ove_tensor_info>() - 48usize];
    ["Alignment of ove_tensor_info"][::std::mem::align_of::<ove_tensor_info>() - 8usize];
    ["Offset of field: ove_tensor_info::data"]
        [::std::mem::offset_of!(ove_tensor_info, data) - 0usize];
    ["Offset of field: ove_tensor_info::size"]
        [::std::mem::offset_of!(ove_tensor_info, size) - 8usize];
    ["Offset of field: ove_tensor_info::type_"]
        [::std::mem::offset_of!(ove_tensor_info, type_) - 16usize];
    ["Offset of field: ove_tensor_info::ndims"]
        [::std::mem::offset_of!(ove_tensor_info, ndims) - 20usize];
    ["Offset of field: ove_tensor_info::dims"]
        [::std::mem::offset_of!(ove_tensor_info, dims) - 24usize];
};
...
pub struct ove_model_config {
    ...
    pub model_data: *const ::std::os::raw::c_void,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_model_config"][::std::mem::size_of::<ove_model_config>() - 24usize];
    ["Alignment of ove_model_config"][::std::mem::align_of::<ove_model_config>() - 8usize];
    ["Offset of field: ove_model_config::model_data"]
        [::std::mem::offset_of!(ove_model_config, model_data) - 0usize];
    ["Offset of field: ove_model_config::model_size"]
        [::std::mem::offset_of!(ove_model_config, model_size) - 8usize];
    ["Offset of field: ove_model_config::arena_size"]
        [::std::mem::offset_of!(ove_model_config, arena_size) - 16usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_model_invoke(model: ove_model_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_sockaddr_t"][::std::mem::size_of::<ove_sockaddr_t>() - 24usize];
    ["Alignment of ove_sockaddr_t"][::std::mem::align_of::<ove_sockaddr_t>() - 4usize];
    ["Offset of field: ove_sockaddr_t::family"]
        [::std::mem::offset_of!(ove_sockaddr_t, family) - 0usize];
    ["Offset of field: ove_sockaddr_t::port"]
        [::std::mem::offset_of!(ove_sockaddr_t, port) - 4usize];
    ["Offset of field: ove_sockaddr_t::addr"]
        [::std::mem::offset_of!(ove_sockaddr_t, addr) - 6usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_netif_config_t"][::std::mem::size_of::<ove_netif_config_t>() - 100usize];
    ["Alignment of ove_netif_config_t"][::std::mem::align_of::<ove_netif_config_t>() - 4usize];
    ["Offset of field: ove_netif_config_t::use_dhcp"]
        [::std::mem::offset_of!(ove_netif_config_t, use_dhcp) - 0usize];
    ["Offset of field: ove_netif_config_t::static_ip"]
        [::std::mem::offset_of!(ove_netif_config_t, static_ip) - 4usize];
    ["Offset of field: ove_netif_config_t::gateway"]
        [::std::mem::offset_of!(ove_netif_config_t, gateway) - 28usize];
    ["Offset of field: ove_netif_config_t::netmask"]
        [::std::mem::offset_of!(ove_netif_config_t, netmask) - 52usize];
    ["Offset of field: ove_netif_config_t::dns"]
        [::std::mem::offset_of!(ove_netif_config_t, dns) - 76usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_netif_create(netif: *mut ove_netif_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub struct ove_tls_config_t {
    ...
    pub ca_cert: *const ::std::os::raw::c_uchar,
    ...
    pub allow_insecure: ::std::os::raw::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_tls_config_t"][::std::mem::size_of::<ove_tls_config_t>() - 64usize];
    ["Alignment of ove_tls_config_t"][::std::mem::align_of::<ove_tls_config_t>() - 8usize];
    ["Offset of field: ove_tls_config_t::ca_cert"]
        [::std::mem::offset_of!(ove_tls_config_t, ca_cert) - 0usize];
    ["Offset of field: ove_tls_config_t::ca_cert_len"]
        [::std::mem::offset_of!(ove_tls_config_t, ca_cert_len) - 8usize];
    ["Offset of field: ove_tls_config_t::hostname"]
        [::std::mem::offset_of!(ove_tls_config_t, hostname) - 16usize];
    ["Offset of field: ove_tls_config_t::client_cert"]
        [::std::mem::offset_of!(ove_tls_config_t, client_cert) - 24usize];
    ["Offset of field: ove_tls_config_t::client_cert_len"]
        [::std::mem::offset_of!(ove_tls_config_t, client_cert_len) - 32usize];
    ["Offset of field: ove_tls_config_t::client_key"]
        [::std::mem::offset_of!(ove_tls_config_t, client_key) - 40usize];
    ["Offset of field: ove_tls_config_t::client_key_len"]
        [::std::mem::offset_of!(ove_tls_config_t, client_key_len) - 48usize];
    ["Offset of field: ove_tls_config_t::allow_insecure"]
        [::std::mem::offset_of!(ove_tls_config_t, allow_insecure) - 56usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_tls_create(tls: *mut ove_tls_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub type ove_http_method_t = ::std::os::raw::c_uint;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_http_header_t"][::std::mem::size_of::<ove_http_header_t>() - 16usize];
    ["Alignment of ove_http_header_t"][::std::mem::align_of::<ove_http_header_t>() - 8usize];
    ["Offset of field: ove_http_header_t::name"]
        [::std::mem::offset_of!(ove_http_header_t, name) - 0usize];
    ["Offset of field: ove_http_header_t::value"]
        [::std::mem::offset_of!(ove_http_header_t, value) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_http_response_t"][::std::mem::size_of::<ove_http_response_t>() - 40usize];
    ["Alignment of ove_http_response_t"][::std::mem::align_of::<ove_http_response_t>() - 8usize];
    ["Offset of field: ove_http_response_t::status"]
        [::std::mem::offset_of!(ove_http_response_t, status) - 0usize];
    ["Offset of field: ove_http_response_t::body"]
        [::std::mem::offset_of!(ove_http_response_t, body) - 8usize];
    ["Offset of field: ove_http_response_t::body_len"]
        [::std::mem::offset_of!(ove_http_response_t, body_len) - 16usize];
    ["Offset of field: ove_http_response_t::headers"]
        [::std::mem::offset_of!(ove_http_response_t, headers) - 24usize];
    ["Offset of field: ove_http_response_t::headers_len"]
        [::std::mem::offset_of!(ove_http_response_t, headers_len) - 32usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_http_client_create(client: *mut ove_http_client_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub type ove_mqtt_qos_t = ::std::os::raw::c_uint;
...
pub type ove_mqtt_msg_cb = ::std::option::Option<
    unsafe extern "C" fn(
...
pub struct ove_mqtt_config_t {
    ...
    pub client_id: *const ::std::os::raw::c_char,
    ...
    pub use_tls: ::std::os::raw::c_int,
    #[doc = "< PEM/DER CA cert used when @c use_tls is set (may be NULL)."]
    pub tls_ca_cert: *const ::std::os::raw::c_uchar,
    ...
    pub tls_allow_insecure: ::std::os::raw::c_int,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_mqtt_config_t"][::std::mem::size_of::<ove_mqtt_config_t>() - 88usize];
    ["Alignment of ove_mqtt_config_t"][::std::mem::align_of::<ove_mqtt_config_t>() - 8usize];
    ["Offset of field: ove_mqtt_config_t::host"]
        [::std::mem::offset_of!(ove_mqtt_config_t, host) - 0usize];
    ["Offset of field: ove_mqtt_config_t::port"]
        [::std::mem::offset_of!(ove_mqtt_config_t, port) - 8usize];
    ["Offset of field: ove_mqtt_config_t::client_id"]
        [::std::mem::offset_of!(ove_mqtt_config_t, client_id) - 16usize];
    ["Offset of field: ove_mqtt_config_t::username"]
        [::std::mem::offset_of!(ove_mqtt_config_t, username) - 24usize];
    ["Offset of field: ove_mqtt_config_t::password"]
        [::std::mem::offset_of!(ove_mqtt_config_t, password) - 32usize];
    ["Offset of field: ove_mqtt_config_t::keep_alive_s"]
        [::std::mem::offset_of!(ove_mqtt_config_t, keep_alive_s) - 40usize];
    ["Offset of field: ove_mqtt_config_t::use_tls"]
        [::std::mem::offset_of!(ove_mqtt_config_t, use_tls) - 44usize];
    ["Offset of field: ove_mqtt_config_t::tls_ca_cert"]
        [::std::mem::offset_of!(ove_mqtt_config_t, tls_ca_cert) - 48usize];
    ["Offset of field: ove_mqtt_config_t::tls_ca_cert_len"]
        [::std::mem::offset_of!(ove_mqtt_config_t, tls_ca_cert_len) - 56usize];
    ["Offset of field: ove_mqtt_config_t::tls_allow_insecure"]
        [::std::mem::offset_of!(ove_mqtt_config_t, tls_allow_insecure) - 64usize];
    ["Offset of field: ove_mqtt_config_t::on_message"]
        [::std::mem::offset_of!(ove_mqtt_config_t, on_message) - 72usize];
    ["Offset of field: ove_mqtt_config_t::user_data"]
        [::std::mem::offset_of!(ove_mqtt_config_t, user_data) - 80usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_mqtt_loop(client: ove_mqtt_client_t, timeout_ns: u64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " @brief Heap-allocate and initialise an MQTT client.\n\n @param[out] client Handle written on success.\n @return OVE_OK on success, negative error code on failure."]
    pub fn ove_mqtt_client_create(client: *mut ove_mqtt_client_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_sntp_config_t"][::std::mem::size_of::<ove_sntp_config_t>() - 16usize];
    ["Alignment of ove_sntp_config_t"][::std::mem::align_of::<ove_sntp_config_t>() - 8usize];
    ["Offset of field: ove_sntp_config_t::server"]
        [::std::mem::offset_of!(ove_sntp_config_t, server) - 0usize];
    ["Offset of field: ove_sntp_config_t::timeout_ns"]
        [::std::mem::offset_of!(ove_sntp_config_t, timeout_ns) - 8usize];
};
unsafe extern "C" {
    ...
    pub fn ove_sntp_sync(cfg: *const ove_sntp_config_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_sntp_get_offset_us(offset_us: *mut i64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_sntp_get_utc(utc_s: *mut u32) -> ::std::os::raw::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type ove_httpd_handler_t = ::std::option::Option<
    unsafe extern "C" fn(
...
pub struct ove_httpd_config_t {
    ...
    pub max_body_size: ::std::os::raw::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_httpd_config_t"][::std::mem::size_of::<ove_httpd_config_t>() - 8usize];
    ["Alignment of ove_httpd_config_t"][::std::mem::align_of::<ove_httpd_config_t>() - 4usize];
    ["Offset of field: ove_httpd_config_t::port"]
        [::std::mem::offset_of!(ove_httpd_config_t, port) - 0usize];
    ["Offset of field: ove_httpd_config_t::max_body_size"]
        [::std::mem::offset_of!(ove_httpd_config_t, max_body_size) - 4usize];
};
unsafe extern "C" {
    ...
    pub fn ove_httpd_start(cfg: *const ove_httpd_config_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_httpd_req_method(req: *mut ove_httpd_req_t) -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
    #[doc = " @brief Get the full request path (e.g. \"/api/leds/0\")."]
    pub fn ove_httpd_req_path(req: *mut ove_httpd_req_t) -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
    #[doc = " @brief Get the query string after '?' (or NULL)."]
    pub fn ove_httpd_req_query(req: *mut ove_httpd_req_t) -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
    #[doc = " @brief Get the request body (or NULL)."]
    pub fn ove_httpd_req_body(req: *mut ove_httpd_req_t) -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
...
pub type ove_httpd_ws_handler_t = ::std::option::Option<
    unsafe extern "C" fn(
...
pub type ove_httpd_ws_close_handler_t =
    ::std::option::Option<unsafe extern "C" fn(conn: *mut ove_httpd_ws_conn_t)>;
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_httpd_ws_active_count() -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " @brief Return non-zero if the HTTP headers request a WebSocket upgrade."]
    pub fn ove_httpd_ws_is_upgrade(headers: *const ::std::os::raw::c_char)
    -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub type ove_uart_parity_t = ::std::os::raw::c_uint;
...
pub type ove_uart_stop_t = ::std::os::raw::c_uint;
...
pub type ove_uart_flow_t = ::std::os::raw::c_uint;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_uart_cfg"][::std::mem::size_of::<ove_uart_cfg>() - 32usize];
    ["Alignment of ove_uart_cfg"][::std::mem::align_of::<ove_uart_cfg>() - 8usize];
    ["Offset of field: ove_uart_cfg::instance"]
        [::std::mem::offset_of!(ove_uart_cfg, instance) - 0usize];
    ["Offset of field: ove_uart_cfg::baudrate"]
        [::std::mem::offset_of!(ove_uart_cfg, baudrate) - 4usize];
    ["Offset of field: ove_uart_cfg::data_bits"]
        [::std::mem::offset_of!(ove_uart_cfg, data_bits) - 8usize];
    ["Offset of field: ove_uart_cfg::parity"]
        [::std::mem::offset_of!(ove_uart_cfg, parity) - 12usize];
    ["Offset of field: ove_uart_cfg::stop_bits"]
        [::std::mem::offset_of!(ove_uart_cfg, stop_bits) - 16usize];
    ["Offset of field: ove_uart_cfg::flow_control"]
        [::std::mem::offset_of!(ove_uart_cfg, flow_control) - 20usize];
    ["Offset of field: ove_uart_cfg::rx_buf_size"]
        [::std::mem::offset_of!(ove_uart_cfg, rx_buf_size) - 24usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_uart_flush(uart: ove_uart_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_uart_rx_isr_push(uart: ove_uart_t, data: *const ::std::os::raw::c_void, len: usize);
}
unsafe extern "C" {
...
pub type ove_spi_mode_t = ::std::os::raw::c_uint;
...
pub type ove_spi_bit_order_t = ::std::os::raw::c_uint;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_spi_cfg"][::std::mem::size_of::<ove_spi_cfg>() - 20usize];
    ["Alignment of ove_spi_cfg"][::std::mem::align_of::<ove_spi_cfg>() - 4usize];
    ["Offset of field: ove_spi_cfg::instance"]
        [::std::mem::offset_of!(ove_spi_cfg, instance) - 0usize];
    ["Offset of field: ove_spi_cfg::clock_hz"]
        [::std::mem::offset_of!(ove_spi_cfg, clock_hz) - 4usize];
    ["Offset of field: ove_spi_cfg::mode"][::std::mem::offset_of!(ove_spi_cfg, mode) - 8usize];
    ["Offset of field: ove_spi_cfg::bit_order"]
        [::std::mem::offset_of!(ove_spi_cfg, bit_order) - 12usize];
    ["Offset of field: ove_spi_cfg::word_size"]
        [::std::mem::offset_of!(ove_spi_cfg, word_size) - 16usize];
};
...
pub struct ove_spi_cs {
    ...
    pub gpio_port: ::std::os::raw::c_uint,
    #[doc = "< GPIO pin index for CS pin."]
    pub gpio_pin: ::std::os::raw::c_uint,
    #[doc = "< Non-zero if CS is active low (common)."]
    pub active_low: ::std::os::raw::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_spi_cs"][::std::mem::size_of::<ove_spi_cs>() - 12usize];
    ["Alignment of ove_spi_cs"][::std::mem::align_of::<ove_spi_cs>() - 4usize];
    ["Offset of field: ove_spi_cs::gpio_port"]
        [::std::mem::offset_of!(ove_spi_cs, gpio_port) - 0usize];
    ["Offset of field: ove_spi_cs::gpio_pin"]
        [::std::mem::offset_of!(ove_spi_cs, gpio_pin) - 4usize];
    ["Offset of field: ove_spi_cs::active_low"]
        [::std::mem::offset_of!(ove_spi_cs, active_low) - 8usize];
};
...
pub struct ove_spi_xfer {
    ...
    pub tx: *const ::std::os::raw::c_void,
    #[doc = "< RX buffer, or NULL for TX-only."]
    pub rx: *mut ::std::os::raw::c_void,
    #[doc = "< Number of bytes in this segment."]
    pub len: usize,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_spi_xfer"][::std::mem::size_of::<ove_spi_xfer>() - 24usize];
    ["Alignment of ove_spi_xfer"][::std::mem::align_of::<ove_spi_xfer>() - 8usize];
    ["Offset of field: ove_spi_xfer::tx"][::std::mem::offset_of!(ove_spi_xfer, tx) - 0usize];
    ["Offset of field: ove_spi_xfer::rx"][::std::mem::offset_of!(ove_spi_xfer, rx) - 8usize];
    ["Offset of field: ove_spi_xfer::len"][::std::mem::offset_of!(ove_spi_xfer, len) - 16usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_spi_create(spi: *mut ove_spi_t, cfg: *const ove_spi_cfg) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub type ove_i2c_speed_t = ::std::os::raw::c_uint;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_i2c_cfg"][::std::mem::size_of::<ove_i2c_cfg>() - 8usize];
    ["Alignment of ove_i2c_cfg"][::std::mem::align_of::<ove_i2c_cfg>() - 4usize];
    ["Offset of field: ove_i2c_cfg::instance"]
        [::std::mem::offset_of!(ove_i2c_cfg, instance) - 0usize];
    ["Offset of field: ove_i2c_cfg::speed"][::std::mem::offset_of!(ove_i2c_cfg, speed) - 4usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn ove_i2c_create(i2c: *mut ove_i2c_t, cfg: *const ove_i2c_cfg) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_i2c_probe(i2c: ove_i2c_t, addr: u16, timeout_ns: u64) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub type ove_i2s_dir_t = ::std::os::raw::c_uint;
...
pub type ove_i2s_cb_t = ::std::option::Option<
    unsafe extern "C" fn(i2s: ove_i2s_t, user_data: *mut ::std::os::raw::c_void),
>;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_i2s_cfg"][::std::mem::size_of::<ove_i2s_cfg>() - 24usize];
    ["Alignment of ove_i2s_cfg"][::std::mem::align_of::<ove_i2s_cfg>() - 8usize];
    ["Offset of field: ove_i2s_cfg::instance"]
        [::std::mem::offset_of!(ove_i2s_cfg, instance) - 0usize];
    ["Offset of field: ove_i2s_cfg::sample_rate"]
        [::std::mem::offset_of!(ove_i2s_cfg, sample_rate) - 4usize];
    ["Offset of field: ove_i2s_cfg::bit_depth"]
        [::std::mem::offset_of!(ove_i2s_cfg, bit_depth) - 8usize];
    ["Offset of field: ove_i2s_cfg::channels"]
        [::std::mem::offset_of!(ove_i2s_cfg, channels) - 9usize];
    ["Offset of field: ove_i2s_cfg::direction"]
        [::std::mem::offset_of!(ove_i2s_cfg, direction) - 12usize];
    ["Offset of field: ove_i2s_cfg::dma_buf_samples"]
        [::std::mem::offset_of!(ove_i2s_cfg, dma_buf_samples) - 16usize];
};
unsafe extern "C" {
    ...
    pub fn ove_i2s_init(
        ...
        tx_dma_buf: *mut ::std::os::raw::c_void,
        rx_dma_buf: *mut ::std::os::raw::c_void,
...
unsafe extern "C" {
    ...
    pub fn ove_i2s_create(i2s: *mut ove_i2s_t, cfg: *const ove_i2s_cfg) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_i2s_start(i2s: ove_i2s_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " @brief Stop I2S DMA streaming.\n\n @param[in] i2s I2S handle.\n @return OVE_OK on success, negative error code on failure."]
    pub fn ove_i2s_stop(i2s: ove_i2s_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " @brief Pause I2S DMA streaming (can be resumed).\n\n @param[in] i2s I2S handle.\n @return OVE_OK on success, negative error code on failure."]
    pub fn ove_i2s_pause(i2s: ove_i2s_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " @brief Resume I2S DMA streaming after pause.\n\n @param[in] i2s I2S handle.\n @return OVE_OK on success, negative error code on failure."]
    pub fn ove_i2s_resume(i2s: ove_i2s_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_i2s_rx_buf(i2s: ove_i2s_t) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
    ...
    pub fn ove_i2s_tx_buf(i2s: ove_i2s_t) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
...
pub type ove_pm_state_t = ::std::os::raw::c_uint;
#[doc = "< GPIO pin edge."]
...
pub type ove_pm_wake_type_t = ::std::os::raw::c_uint;
...
pub type ove_pm_domain_t = ::std::os::raw::c_uint;
...
pub type ove_pm_event_t = ::std::os::raw::c_uint;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_pm_cfg"][::std::mem::size_of::<ove_pm_cfg>() - 12usize];
    ["Alignment of ove_pm_cfg"][::std::mem::align_of::<ove_pm_cfg>() - 4usize];
    ["Offset of field: ove_pm_cfg::idle_threshold_ms"]
        [::std::mem::offset_of!(ove_pm_cfg, idle_threshold_ms) - 0usize];
    ["Offset of field: ove_pm_cfg::standby_threshold_ms"]
        [::std::mem::offset_of!(ove_pm_cfg, standby_threshold_ms) - 4usize];
    ["Offset of field: ove_pm_cfg::deep_sleep_threshold_ms"]
        [::std::mem::offset_of!(ove_pm_cfg, deep_sleep_threshold_ms) - 8usize];
};
...
const _: () = {
    ["Size of ove_pm_wake_src__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::size_of::<ove_pm_wake_src__bindgen_ty_1__bindgen_ty_1>() - 12usize];
    ["Alignment of ove_pm_wake_src__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::align_of::<ove_pm_wake_src__bindgen_ty_1__bindgen_ty_1>() - 4usize];
    ["Offset of field: ove_pm_wake_src__bindgen_ty_1__bindgen_ty_1::port"]
        [::std::mem::offset_of!(ove_pm_wake_src__bindgen_ty_1__bindgen_ty_1, port) - 0usize];
    ["Offset of field: ove_pm_wake_src__bindgen_ty_1__bindgen_ty_1::pin"]
        [::std::mem::offset_of!(ove_pm_wake_src__bindgen_ty_1__bindgen_ty_1, pin) - 4usize];
    ["Offset of field: ove_pm_wake_src__bindgen_ty_1__bindgen_ty_1::edge"]
        [::std::mem::offset_of!(ove_pm_wake_src__bindgen_ty_1__bindgen_ty_1, edge) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ["Size of ove_pm_wake_src__bindgen_ty_1__bindgen_ty_2"]
        [::std::mem::size_of::<ove_pm_wake_src__bindgen_ty_1__bindgen_ty_2>() - 4usize];
    ["Alignment of ove_pm_wake_src__bindgen_ty_1__bindgen_ty_2"]
        [::std::mem::align_of::<ove_pm_wake_src__bindgen_ty_1__bindgen_ty_2>() - 4usize];
    ["Offset of field: ove_pm_wake_src__bindgen_ty_1__bindgen_ty_2::timeout_ms"]
        [::std::mem::offset_of!(ove_pm_wake_src__bindgen_ty_1__bindgen_ty_2, timeout_ms) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ["Size of ove_pm_wake_src__bindgen_ty_1__bindgen_ty_3"]
        [::std::mem::size_of::<ove_pm_wake_src__bindgen_ty_1__bindgen_ty_3>() - 4usize];
    ["Alignment of ove_pm_wake_src__bindgen_ty_1__bindgen_ty_3"]
        [::std::mem::align_of::<ove_pm_wake_src__bindgen_ty_1__bindgen_ty_3>() - 4usize];
    ["Offset of field: ove_pm_wake_src__bindgen_ty_1__bindgen_ty_3::instance"]
        [::std::mem::offset_of!(ove_pm_wake_src__bindgen_ty_1__bindgen_ty_3, instance) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ["Size of ove_pm_wake_src__bindgen_ty_1__bindgen_ty_4"]
        [::std::mem::size_of::<ove_pm_wake_src__bindgen_ty_1__bindgen_ty_4>() - 4usize];
    ["Alignment of ove_pm_wake_src__bindgen_ty_1__bindgen_ty_4"]
        [::std::mem::align_of::<ove_pm_wake_src__bindgen_ty_1__bindgen_ty_4>() - 4usize];
    ["Offset of field: ove_pm_wake_src__bindgen_ty_1__bindgen_ty_4::alarm_ms"]
        [::std::mem::offset_of!(ove_pm_wake_src__bindgen_ty_1__bindgen_ty_4, alarm_ms) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_pm_wake_src__bindgen_ty_1"]
        [::std::mem::size_of::<ove_pm_wake_src__bindgen_ty_1>() - 12usize];
    ["Alignment of ove_pm_wake_src__bindgen_ty_1"]
        [::std::mem::align_of::<ove_pm_wake_src__bindgen_ty_1>() - 4usize];
    ["Offset of field: ove_pm_wake_src__bindgen_ty_1::gpio"]
        [::std::mem::offset_of!(ove_pm_wake_src__bindgen_ty_1, gpio) - 0usize];
    ["Offset of field: ove_pm_wake_src__bindgen_ty_1::timer"]
        [::std::mem::offset_of!(ove_pm_wake_src__bindgen_ty_1, timer) - 0usize];
    ["Offset of field: ove_pm_wake_src__bindgen_ty_1::uart"]
        [::std::mem::offset_of!(ove_pm_wake_src__bindgen_ty_1, uart) - 0usize];
    ["Offset of field: ove_pm_wake_src__bindgen_ty_1::rtc"]
        [::std::mem::offset_of!(ove_pm_wake_src__bindgen_ty_1, rtc) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_pm_wake_src"][::std::mem::size_of::<ove_pm_wake_src>() - 16usize];
    ["Alignment of ove_pm_wake_src"][::std::mem::align_of::<ove_pm_wake_src>() - 4usize];
    ["Offset of field: ove_pm_wake_src::type_"]
        [::std::mem::offset_of!(ove_pm_wake_src, type_) - 0usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ove_pm_stats"][::std::mem::size_of::<ove_pm_stats>() - 64usize];
    ["Alignment of ove_pm_stats"][::std::mem::align_of::<ove_pm_stats>() - 8usize];
    ["Offset of field: ove_pm_stats::time_in_state_us"]
        [::std::mem::offset_of!(ove_pm_stats, time_in_state_us) - 0usize];
    ["Offset of field: ove_pm_stats::transition_count"]
        [::std::mem::offset_of!(ove_pm_stats, transition_count) - 32usize];
    ["Offset of field: ove_pm_stats::total_runtime_us"]
        [::std::mem::offset_of!(ove_pm_stats, total_runtime_us) - 48usize];
    ["Offset of field: ove_pm_stats::active_pct_x100"]
        [::std::mem::offset_of!(ove_pm_stats, active_pct_x100) - 56usize];
};
...
pub type ove_pm_policy_fn = ::std::option::Option<
    unsafe extern "C" fn(
...
pub type ove_pm_notify_fn = ::std::option::Option<
    unsafe extern "C" fn(
...
unsafe extern "C" {
    ...
    pub fn ove_pm_init(cfg: *const ove_pm_cfg) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_pm_set_state(state: ove_pm_state_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_pm_wake_register(src: *const ove_pm_wake_src) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_pm_wake_unregister(src: *const ove_pm_wake_src) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_pm_domain_request(domain: ove_pm_domain_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn ove_pm_domain_release(domain: ove_pm_domain_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " @brief Query the current reference count for a domain.\n\n @param[in] domain  Domain identifier.\n @return Reference count (>= 0), or negative error code."]
    pub fn ove_pm_domain_get_refcount(domain: ove_pm_domain_t) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_pm_get_stats(stats: *mut ove_pm_stats) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ove_pm_set_budget(target_low_power_pct_x100: u32) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " @brief Query actual low-power percentage vs. budget target.\n\n @param[out] actual_pct_x100  Actual low-power % in hundredths.\n @return OVE_OK on success, negative error code on failure."]
    pub fn ove_pm_get_budget_status(actual_pct_x100: *mut u32) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lv_color_t"][::std::mem::size_of::<lv_color_t>() - 3usize];
    ["Alignment of lv_color_t"][::std::mem::align_of::<lv_color_t>() - 1usize];
    ["Offset of field: lv_color_t::blue"][::std::mem::offset_of!(lv_color_t, blue) - 0usize];
    ["Offset of field: lv_color_t::green"][::std::mem::offset_of!(lv_color_t, green) - 1usize];
    ["Offset of field: lv_color_t::red"][::std::mem::offset_of!(lv_color_t, red) - 2usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct lv_font_t {
    pub dsc: *const ::std::os::raw::c_void,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lv_font_t"][::std::mem::size_of::<lv_font_t>() - 8usize];
    ["Alignment of lv_font_t"][::std::mem::align_of::<lv_font_t>() - 8usize];
    ["Offset of field: lv_font_t::dsc"][::std::mem::offset_of!(lv_font_t, dsc) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lv_style_t"][::std::mem::size_of::<lv_style_t>() - 4usize];
    ["Alignment of lv_style_t"][::std::mem::align_of::<lv_style_t>() - 4usize];
    ["Offset of field: lv_style_t::dummy"][::std::mem::offset_of!(lv_style_t, dummy) - 0usize];
};
pub type lv_opa_t = u8;
pub type lv_obj_flag_t = u32;
pub type lv_state_t = u32;
pub type lv_anim_enable_t = bool;
pub type lv_event_t = ::std::os::raw::c_void;
pub type lv_event_cb_t = ::std::option::Option<unsafe extern "C" fn(e: *mut lv_event_t)>;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lv_calendar_date_t"][::std::mem::size_of::<lv_calendar_date_t>() - 12usize];
    ["Alignment of lv_calendar_date_t"][::std::mem::align_of::<lv_calendar_date_t>() - 4usize];
    ["Offset of field: lv_calendar_date_t::year"]
        [::std::mem::offset_of!(lv_calendar_date_t, year) - 0usize];
    ["Offset of field: lv_calendar_date_t::month"]
        [::std::mem::offset_of!(lv_calendar_date_t, month) - 4usize];
    ["Offset of field: lv_calendar_date_t::day"]
        [::std::mem::offset_of!(lv_calendar_date_t, day) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lv_subject_t"][::std::mem::size_of::<lv_subject_t>() - 64usize];
    ["Alignment of lv_subject_t"][::std::mem::align_of::<lv_subject_t>() - 4usize];
    ["Offset of field: lv_subject_t::dummy"][::std::mem::offset_of!(lv_subject_t, dummy) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lv_anim_t"][::std::mem::size_of::<lv_anim_t>() - 136usize];
    ["Alignment of lv_anim_t"][::std::mem::align_of::<lv_anim_t>() - 8usize];
    ["Offset of field: lv_anim_t::var"][::std::mem::offset_of!(lv_anim_t, var) - 0usize];
    ["Offset of field: lv_anim_t::dummy"][::std::mem::offset_of!(lv_anim_t, dummy) - 8usize];
};
pub type lv_timer_cb_t = ::std::option::Option<unsafe extern "C" fn(arg1: *mut lv_timer_t)>;
pub type lv_anim_exec_xcb_t =
    ::std::option::Option<unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void, arg2: i32)>;
pub type lv_anim_path_cb_t =
    ::std::option::Option<unsafe extern "C" fn(arg1: *const lv_anim_t) -> i32>;
pub type lv_anim_completed_cb_t = ::std::option::Option<unsafe extern "C" fn(arg1: *mut lv_anim_t)>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lv_image_header_t"][::std::mem::size_of::<lv_image_header_t>() - 12usize];
    ["Alignment of lv_image_header_t"][::std::mem::align_of::<lv_image_header_t>() - 4usize];
    ["Offset of field: lv_image_header_t::cf"]
        [::std::mem::offset_of!(lv_image_header_t, cf) - 0usize];
    ["Offset of field: lv_image_header_t::w"]
        [::std::mem::offset_of!(lv_image_header_t, w) - 4usize];
    ["Offset of field: lv_image_header_t::h"]
        [::std::mem::offset_of!(lv_image_header_t, h) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lv_image_dsc_t"][::std::mem::size_of::<lv_image_dsc_t>() - 24usize];
    ["Alignment of lv_image_dsc_t"][::std::mem::align_of::<lv_image_dsc_t>() - 8usize];
    ["Offset of field: lv_image_dsc_t::header"]
        [::std::mem::offset_of!(lv_image_dsc_t, header) - 0usize];
    ["Offset of field: lv_image_dsc_t::data_size"]
        [::std::mem::offset_of!(lv_image_dsc_t, data_size) - 12usize];
    ["Offset of field: lv_image_dsc_t::data"]
        [::std::mem::offset_of!(lv_image_dsc_t, data) - 16usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_obj_set_user_data(obj: *mut lv_obj_t, data: *mut ::std::os::raw::c_void);
}
unsafe extern "C" {
    pub fn lv_obj_get_user_data(obj: *mut lv_obj_t) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_event_get_user_data(e: *mut lv_event_t) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_label_set_text(obj: *mut lv_obj_t, text: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn lv_label_set_text_static(obj: *mut lv_obj_t, text: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_checkbox_set_text(obj: *mut lv_obj_t, text: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn lv_checkbox_set_text_static(obj: *mut lv_obj_t, text: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_image_set_src(obj: *mut lv_obj_t, src: *const ::std::os::raw::c_void);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_msgbox_add_title(obj: *mut lv_obj_t, title: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn lv_msgbox_add_text(obj: *mut lv_obj_t, text: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_textarea_set_text(obj: *mut lv_obj_t, text: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn lv_textarea_add_text(obj: *mut lv_obj_t, text: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_textarea_set_accepted_chars(obj: *mut lv_obj_t, list: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_textarea_get_text(obj: *mut lv_obj_t) -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_dropdown_set_options(obj: *mut lv_obj_t, opts: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn lv_dropdown_set_options_static(obj: *mut lv_obj_t, opts: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn lv_dropdown_add_option(obj: *mut lv_obj_t, opt: *const ::std::os::raw::c_char, pos: u32);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_dropdown_set_symbol(obj: *mut lv_obj_t, symbol: *const ::std::os::raw::c_void);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_tabview_rename_tab(tv: *mut lv_obj_t, idx: u32, name: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
...
pub type lv_observer_cb_t = ::std::option::Option<
...
unsafe extern "C" {
    pub fn lv_anim_set_var(a: *mut lv_anim_t, var: *mut ::std::os::raw::c_void);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_anim_delete(var: *mut ::std::os::raw::c_void, exec_cb: lv_anim_exec_xcb_t) -> bool;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_timer_get_user_data(timer: *mut lv_timer_t) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lv_point_t"][::std::mem::size_of::<lv_point_t>() - 8usize];
    ["Alignment of lv_point_t"][::std::mem::align_of::<lv_point_t>() - 4usize];
    ["Offset of field: lv_point_t::x"][::std::mem::offset_of!(lv_point_t, x) - 0usize];
    ["Offset of field: lv_point_t::y"][::std::mem::offset_of!(lv_point_t, y) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
unsafe extern "C" {
    pub fn lv_event_get_param(e: *mut lv_event_t) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lv_anim_set_user_data(a: *mut lv_anim_t, user_data: *mut ::std::os::raw::c_void);
}
unsafe extern "C" {
    pub fn lv_anim_get_user_data(a: *const lv_anim_t) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
    pub fn lv_anim_set_custom_exec_cb(
        a: *mut lv_anim_t,
        exec_cb: ::std::option::Option<unsafe extern "C" fn(arg1: *mut lv_anim_t, arg2: i32)>,
    );
}
unsafe extern "C" {
