...
/// Opaque shim type for `lv_font_montserrat_*` re-declarations.
///
...
///
/// If Zig translate-c starts handling bitfields, the externs can switch
/// back to `c.lv_font_t` and this opaque can be deleted.
