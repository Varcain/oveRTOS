...
const time_cases = [_]bench.CBenchCase{
    bench.case(time_case_get_us),
    bench.case(time_case_delay_1ms),
};
...
const thread_cases = [_]bench.CBenchCase{
    bench.case(thread_case_create_destroy),
    bench.case(thread_case_yield),
    bench.case(thread_case_sleep_1ms),
    bench.case(thread_case_ctx_switch),
};
...
const sync_cases = [_]bench.CBenchCase{
    bench.case(sync_case_mutex_memory),
    bench.case(sync_case_sem_memory),
    bench.case(sync_case_event_memory),
    bench.case(sync_case_condvar_memory),
    bench.case(sync_case_mutex_lock_unlock),
    bench.case(sync_case_mutex_create_destroy),
    bench.case(sync_case_mutex_contention),
    bench.case(sync_case_sem_take_give),
    bench.case(sync_case_sem_create_destroy),
    bench.case(sync_case_event_signal_wait),
    bench.case(sync_case_condvar_signal_wait),
    bench.case(sync_case_rmtx_lock_unlock),
};
...
const queue_cases = [_]bench.CBenchCase{
    bench.case(queue_case_memory),
    bench.case(queue_case_send_receive),
    bench.case(queue_case_create_destroy),
    bench.case(queue_case_throughput),
};
...
const timer_cases = [_]bench.CBenchCase{
    bench.case(timer_case_memory),
    bench.case(timer_case_create_destroy),
    bench.case(timer_case_start_stop),
};
...
const eg_cases = [_]bench.CBenchCase{
    bench.case(eg_case_memory),
    bench.case(eg_case_set_get),
    bench.case(eg_case_create_destroy),
};
...
const wq_cases = [_]bench.CBenchCase{
    bench.case(wq_case_memory),
    bench.case(wq_case_create_destroy),
    bench.case(wq_case_submit_execute),
};
...
const stream_cases = [_]bench.CBenchCase{
    bench.case(stream_case_memory),
    bench.case(stream_case_send_recv),
    bench.case(stream_case_create_destroy),
    bench.case(stream_case_throughput),
};
