...
static constexpr ove::bench::CaseSpec thread_create_destroy_spec{
	.name = "create_destroy",
	.kind = ove::bench::Type::latency,
	.run = &thread_create_destroy_run,
	.iterations = 200,
};
static constexpr ove::bench::CaseSpec thread_yield_spec{
	.name = "yield",
	.kind = ove::bench::Type::latency,
	.run = &thread_yield_run,
};
static constexpr ove::bench::CaseSpec thread_sleep_1ms_spec{
	.name = "sleep_1ms",
	.kind = ove::bench::Type::latency,
	.run = &thread_sleep_1ms_run,
	.iterations = 100,
};
static constexpr ove::bench::CaseSpec ctx_switch_spec{
	.name = "context_switch",
	.kind = ove::bench::Type::latency,
	.run = &ctx_switch_run,
...
static constexpr bench_case_t thread_cases[] = {
	ove::bench::case_<thread_create_destroy_spec>(),
	ove::bench::case_<thread_yield_spec>(),
	ove::bench::case_<thread_sleep_1ms_spec>(),
	ove::bench::case_<ctx_switch_spec>(),
};
